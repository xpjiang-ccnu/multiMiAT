...
## Arguments
* _y_ - Multicategory outcomes (i.e., host phenotype of interest). Multicategory outcomes mainly contain ordinal multicategory outcomes (e.g., disease severity) nomial multicategory outcomes (e.g., tumor subtype).
...
* _covs_ - Confounding factors (e.g., age, gender). Default is covs = NULL.

* _model_ - Multinomial logit models. Default is model = c("bcl", "clm"). "bcl" for baseline category logit model, "clm" for cumulative link model. In addition, "crm" for continuation ratio model can also be used.
...
_$Score.test_ - The _p_-value for the bcl-based score test.

_$MiRKAT.MC_ - The _p_-values for the MiRKAT-MC tests (i.e., MiRKAT-MCN and MiRKAT-MCO).

_$multiMiRKAT_ - The _p_-values for the multiMiRKAT tests (i.e., multiMiRKAT-N and multiMiRKAT-O).

_$multiMiAT_ - The _p_-value for the optimal test (i.e., multiMiAT).
...
* Agarwal D, Zhang NR. Semblance: Anempirical similarity kernel on probability spaces. _Science Advances_ 2019;**5**(12):eaau9630.
...
### Arguments
* _y_ - Multicategory outcomes (i.e., host phenotype of interest). Multicategory outcomes mainly contain ordinal multicategory outcomes (
* , disease severity) nomial multicategory outcomes (e.g., tumor subtype).
