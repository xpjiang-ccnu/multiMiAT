...
## 3.2. Similarity matrix between subjects
...
## 3.3. Microbiome regression-based kernel association test for multicategory phenotypes (multiMiRKAT)

### 3.3.1. Microbiome regression-based kernel individual tests
...
### 3.3.2. Microbiome regression-based kernel omnibus tests
...
\begin{equation}
    Q_l^{kd} = (\overline{\textbf{Y}} - \overline{{\mu}})^T \overline{\textbf{D}}^T \overline{\textbf{W}} \ {\overline{\textbf{K}}}_{kd} \overline{\textbf{W}} \ \overline{\textbf{D}} (\overline{\textbf{Y}} - \overline{{\mu}}).
\end{equation}
where ${\overline{\textbf{K}}}_{kd} = \textbf{I}_{J-1} \otimes \textbf{K}^*_{kd}$. $\textbf{W} = (\overline{\textbf{D}}\overline{\textbf{D}})^{-1}$. $\overline{\textbf{D}} = \partial (\mathbb{X} {\hat{\beta}})/\partial {\mu}$. MiRKAT-MC test consists of bcl-based MiRKAT-MCN test and clm-based MiRKAT-MCO test.



## 3.6. Optimal test for multinomial outcomes
...
##       0.2643       0.0230 
## 
## $multiMiRKAT.bcl.pvs$GK.sigma1
##           BC    U.UniFrac G.UniFrac.00 G.UniFrac.25 G.UniFrac.50 G.UniFrac.75 
##       0.0871       0.0070       0.0601       0.1291       0.2543       0.3283 
##    W.UniFrac  Omni.MiRKAT 
##       0.2993       0.0270 
## 
## $multiMiRKAT.bcl.pvs$LaK.sigma1
##           BC    U.UniFrac G.UniFrac.00 G.UniFrac.25 G.UniFrac.50 G.UniFrac.75 
...
## 
## $MiRKAT.MC
## MiRKAT-MCN MiRKAT_MCO 
##     0.0401     0.0232 
## 
## $multiMiRKAT
## multiMiRKAT-N multiMiRKAT-O 
##         0.029         0.006 
## 
## $multiMiAT
## multiMiAT 
...
* Lozupone CA, Knight Rob. UniFrac: a new phylogenetic method for comparing microbial communities. _Applied and Environmental Microbiology_ 2005;**73**(5):1576-1585.
...
* Touloumis A, et al. GEE for Multinomial Responses Using a Local Odds Ratios Parameterization: GEE for Multinomial Responses Using a Local Odds Ratios Parameterization. _Biom_ 2013,**69**(3):633–640.
